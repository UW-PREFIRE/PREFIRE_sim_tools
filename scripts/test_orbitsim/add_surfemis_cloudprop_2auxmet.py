...
def add_surfemis(ancillary_data_dir, auxmet_in_fpath,
                           output_dir, product_fullver, provenance,just_emis=True):
    """
    Function to read in an Aux_Met file and then do some calculations
    ...
    auxmet_in_fpath: str
        Filepath of the input Aux-Met product file
    output_dir: str
    ...
    out_fname = "raw-"+os.path.basename(auxmet_in_fpath).replace(
                                        'AUX-MET', 'ANC-SfcEmis')
...
if __name__ == "__main__":
    ...
    add_surfemis(ancillary_data_dir, anc_simtruth_in_fpath,
                           output_dir, product_fullver, provenance,
                           just_emis=True)

    #example call
    ##python add_surfemis_cloudprop_2auxmet.py /home/nnn/projects/PREFIRE_sim_tools/scripts/test_orbitsim/ /data/ops/PREFIRE-SAT2/AUX-MET-prelim/PREFIRE_SAT2_AUX-MET_P00_R00_20240706213910_00000.nc /data/users/nnn/IOC_data/SAT2_Anc-SfcEmis/ 'P00_R00'

    #python add_surfemis_cloudprop_2auxmet.py /home/nnn/projects/PREFIRE_sim_tools/scripts/test_orbitsim/ /data/ops/PREFIRE-SAT2/testlocal/AUX-MET/PREFIRE_SAT2_AUX-MET_P99_R00_20240706182831_00640.nc /data/users/nnn/IOC_data/SAT2_Anc-SfcEmis_20240926/ 'P99_R00'
